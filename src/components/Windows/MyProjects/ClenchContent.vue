<template>
  <div class="text-xs md:text-header-window">
    ...
    >
      ...
      <a rel="noopener" href="https://github.com/akulramasubban" <!-- AKUL: TODO: replace with real project repo --> target="_blank" class="cursor-pointer">{{ $t('buttons.linkRepository') }}</a>
    </div>
